...
//             className="opacity-0 group-hover:opacity-100 p-2 hover:bg-gray-800 rounded-lg transition-all"
//           >
...
//   // Set profile URL only on client side
//   useEffect(() => {
...
//           <div className="flex-1 px-4 py-3 bg-gray-950 border border-gray-800 rounded-lg">
//             <p className="text-sm text-blue-400 font-mono truncate">{profileUrl}</p>
//           </div>
//           <button
...
//               </p>
//             </div>
//             <div className="hidden md:block px-4 py-2 bg-gray-900/50 border border-gray-800 rounded-lg">
...
//           <div className="relative overflow-hidden bg-gradient-to-br from-blue-500/10 via-blue-500/5 to-transparent border border-gray-800 rounded-xl p-6 hover:border-blue-500/50 transition-all">
//             <div className="absolute top-0 right-0 w-20 h-20 bg-blue-500/10 rounded-full blur-2xl"></div>
//             <div className="relative">
//               <div className="w-12 h-12 bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-lg flex items-center justify-center mb-3">
//                 <FaTrophy className="text-blue-400" size={24} />
//               </div>
...
//           <div className="relative overflow-hidden bg-gradient-to-br from-purple-500/10 via-purple-500/5 to-transparent border border-gray-800 rounded-xl p-6 hover:border-purple-500/50 transition-all">
//             <div className="absolute top-0 right-0 w-20 h-20 bg-purple-500/10 rounded-full blur-2xl"></div>
//             <div className="relative">
//               <div className="w-12 h-12 bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-lg flex items-center justify-center mb-3">
...
//           <div className="relative overflow-hidden bg-gradient-to-br from-green-500/10 via-green-500/5 to-transparent border border-gray-800 rounded-xl p-6 hover:border-green-500/50 transition-all">
//             <div className="absolute top-0 right-0 w-20 h-20 bg-green-500/10 rounded-full blur-2xl"></div>
//             <div className="relative">
//               <div className="w-12 h-12 bg-gradient-to-br from-green-500/20 to-green-600/20 rounded-lg flex items-center justify-center mb-3">
...
//           <div className="relative overflow-hidden bg-gradient-to-br from-orange-500/10 via-orange-500/5 to-transparent border border-gray-800 rounded-xl p-6 hover:border-orange-500/50 transition-all">
//             <div className="absolute top-0 right-0 w-20 h-20 bg-orange-500/10 rounded-full blur-2xl"></div>
//             <div className="relative">
//               <div className="w-12 h-12 bg-gradient-to-br from-orange-500/20 to-orange-600/20 rounded-lg flex items-center justify-center mb-3">
//                 <FaCode className="text-orange-400" size={24} />
//               </div>
//               <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Target Roles</p>
//               <p className="text-3xl font-bold text-white">{userData.roles.length}</p>
//             </div>
//           </div>
//         </div>
...
//             Email and full name are managed through your account settings
//           </p>
//         </div>
//       </div>
//     </div>
        ...
        <div className="mb-10">
          ...
          {updateError && (
            <div className="mb-6 p-4 bg-red-500/10 border border-red-500/50 rounded-lg flex items-start gap-3">
              <FaCircleXmark className="text-red-400 mt-0.5" size={18} />
              <div>
